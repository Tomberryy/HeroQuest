class Game {
    ...
    newGame() {
        ...
        if (heroName !== "") {
            ...
            this.heros = new Hero(heroName, 100, 0, 10, 5, 5, 1, 1, 0, 0);
        ...
        switch (event) {
            case 1:
                ...
                heroStats.innerHTML = "<p>" + this.heros.name +
                    ...
                    "<br/>HP : " + this.heros.def +
                    "<br/>str : " + this.heros.str +
                    "<br/>end : " + this.heros.end + "</p>";
            ...
            case 2:
                ...
                //Display shop buttons, hide fight buttons
    ...
    buyWeapon(npc) {
        if (this.heros.gold > this.armors[this.npcs.armor].prix) {
            ...
            console.log("arme");
            //Disable weapon button
            document.getElementById('buyWeapon').display = "none";
        } else {
    ...
    buyArmor() {
        //Hero gets armor
        this.heros.armor = this.npcs.weapon;
        console.log("armor");
        //Disable armor button
        document.getElementById('buyArmor').display = "none";
    }
